...
3. Enter this URL:
   ```
   https://legistream-1.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
1. **Check webhook is saved:**
   ...
   - Verify the webhook URL is showing: `https://legistream-1.preview.emergentagent.com/api/whatsapp/webhook`
...
✅ **Webhook endpoint**: https://legistream-1.preview.emergentagent.com/api/whatsapp/webhook  
...
3. **Twilio calls** your webhook: `https://legistream-1.preview.emergentagent.com/api/whatsapp/webhook`
