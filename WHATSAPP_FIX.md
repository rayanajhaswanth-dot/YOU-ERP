...
3. Enter this URL:
   ```
   https://legismate.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
1. **Check webhook is saved:**
   ...
   - Verify the webhook URL is showing: `https://legismate.preview.emergentagent.com/api/whatsapp/webhook`
...
✅ **Webhook endpoint**: https://legismate.preview.emergentagent.com/api/whatsapp/webhook  
...
3. **Twilio calls** your webhook: `https://legismate.preview.emergentagent.com/api/whatsapp/webhook`
