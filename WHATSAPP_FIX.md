...
3. Enter this URL:
   ```
   https://govflow-3.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
1. **Check webhook is saved:**
   ...
   - Verify the webhook URL is showing: `https://govflow-3.preview.emergentagent.com/api/whatsapp/webhook`
...
✅ **Webhook endpoint**: https://govflow-3.preview.emergentagent.com/api/whatsapp/webhook  
...
3. **Twilio calls** your webhook: `https://govflow-3.preview.emergentagent.com/api/whatsapp/webhook`
