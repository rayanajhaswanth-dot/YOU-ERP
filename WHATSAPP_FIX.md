...
3. Enter this URL:
   ```
   https://politech-hub-4.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
1. **Check webhook is saved:**
   ...
   - Verify the webhook URL is showing: `https://politech-hub-4.preview.emergentagent.com/api/whatsapp/webhook`
...
✅ **Webhook endpoint**: https://politech-hub-4.preview.emergentagent.com/api/whatsapp/webhook  
...
3. **Twilio calls** your webhook: `https://politech-hub-4.preview.emergentagent.com/api/whatsapp/webhook`
