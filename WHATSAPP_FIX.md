...
3. Enter this URL:
   ```
   https://mpconnect-1.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
1. **Check webhook is saved:**
   ...
   - Verify the webhook URL is showing: `https://mpconnect-1.preview.emergentagent.com/api/whatsapp/webhook`
...
✅ **Webhook endpoint**: https://mpconnect-1.preview.emergentagent.com/api/whatsapp/webhook  
...
3. **Twilio calls** your webhook: `https://mpconnect-1.preview.emergentagent.com/api/whatsapp/webhook`
